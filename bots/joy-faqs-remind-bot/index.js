...
const client = new WebClient(process.env.SLACK_BOT_TOKEN_AVADA);
...
const ANNOUNCE_CHANNEL = process.env.SLACK_CHANNEL_JOY_FAQS;
...
async function start() {
  ...
  console.log(`✅ Joy FAQs Remind Bot started (bot=${BOT_USER_ID}, channel=${ANNOUNCE_CHANNEL}, polling every ${config.pollIntervalMinutes}min)`);
  poll();
