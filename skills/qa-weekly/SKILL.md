...
Tự chạy **Thứ 4, 14:00** qua launchd (`com.avada.qa-weekly`, plist ở
...
- **Period** (default: **last completed week**, Wed–Tue):
  - no arg → last completed week
  - "tuần này" → current week Wed → today
...
Compute Wed–Tue for the target week. Default = last completed week.
...
Current in-house (9): Audrey, Alyssa, Jade, Sonny, Andy, Hazel, Phoebe, Linda, Ethan.
