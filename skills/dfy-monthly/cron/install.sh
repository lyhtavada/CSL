#!/bin/bash
#
# Install / reinstall the monthly DFY-report (Chatty, leadership) launchd job.
...
echo "Installed $LABEL → runs the 2nd of each month at 10:00 local."
echo "  plist (source): $SRC"
echo "  symlink:        $DEST"
echo "  log:            /tmp/dfy-monthly.log"
echo
echo "This job posts LAST month's Chatty DFY report straight to the CS channel as Liz."
echo
