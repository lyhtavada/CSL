...
**Status:** Draft — needs Liz + Sam sign-off on PIC/deadline
**Owner:** Liz (CS Leader)
**Created:** 2026-08-22
...
|---|------|-----|----------|--------|
| A1 | Benchmark salary AM tại các công ty SaaS tương đương (thị trường VN, remote) | Liz + Sam | TBD | Not started |
...
| A4 | Trình Sam phê duyệt structure | Liz → Sam | TBD | Not started |
| A5 | Communicate structure mới cho Andy/Jade/Sonny/Alyssa (4 CS đang được gán role AM) | Liz | TBD | Not started |
...
| # | Task | PIC | Deadline | Status |
|---|------|-----|----------|--------|
| B1 | JD cho **AM** (Advanced/Ultimate) — trách nhiệm: onboarding call, health check định kỳ, upsell/renewal, escalation cho merchant tier cao | Liz | TBD | Not started |
...
| B4 | Review JD với Sam + (nếu có) HR trước khi công bố nội bộ | Liz → Sam | TBD | Not started |
| B5 | Công bố JD mới cho team, gắn với KPI framework mới (đã note ở cs-transformation-plan.md checklist "Design new KPI framework for each role") | Liz | TBD | Not started |
...
| # | Task | PIC | Deadline | Status |
|---|------|-----|----------|--------|
| C1.1 | Xác nhận tool ticket hiện tại (Avada Ticket API) đủ chức năng cho merchant tier thấp tự tạo ticket, hay cần build thêm form/portal | Liz + Dev/PM | TBD | Not started |
| C1.2 | Tắt/giới hạn live chat entry point cho Free/Essential trên widget (chỉ hiện AI + nút "Create a ticket") | Dev/PM | TBD | Not started |
...
| C1.5 | Thông báo merchant hiện tại về đổi kênh support (email/in-app announcement) | Liz + Marketing? | TBD | Not started |

### C2. Advanced / Ultimate → AM-led

| # | Task | PIC | Deadline | Status |
|---|------|-----|----------|--------|
| C2.1 | Chốt tool AM cần: CRM/scheduling cho onboarding call + health check (đã list ở open question trong cs-transformation-plan.md — chưa có answer) | Liz + Sam | TBD | Not started |
| C2.2 | Setup call scheduling tool (Calendly/Google Calendar — đã có `gapi` calendar access sẵn, có thể tận dụng) | Liz | TBD | Not started |
| C2.3 | Setup call recording/notes tool nếu cần (tuân thủ policy ghi âm với merchant) | Liz | TBD | Not started |
